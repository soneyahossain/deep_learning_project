...
#This code comes from https://www.kaggle.com/grfiv4/plot-a-confusion-matrix
#And has been edited by the project authors
...
x = input()
my_data = genfromtxt(x, delimiter=',')
my_data = np.round(my_data, 2)
...
y = input()
plot_confusion_matrix(cm = my_data, normalize=False, target_names = classes, title = y)